...
import Constants from 'expo-constants'; // Assurez-vous d'importer Constants si vous l'utilisez pour statusBarHeight
...
const BookScreen = props => {
    return (
        ...
        <View style={styles.container}>
            ...
            <Title title="Rdyard Kliping" constomStyle={styles.sbTitle}/>
           
            <Rating/>
            <Action/>
            <Title left title="You may also like" constomStyle={styles.leftStyle}/>
